...
pm::SubtitlesView::SubtitlesView(QWidget *parent)
    : QWidget(parent)
{
    ui.setupUi(this);
...
pm::SubtitlesView::~SubtitlesView()
{
}

QString pm::SubtitlesView::get_text() const
{
    if (m_is_visible)
...
void pm::SubtitlesView::set_text(const QString& text)
{
    m_text = text;
...
void pm::SubtitlesView::clear()
{
    m_text.clear();
    ui.edtSubtitles->clear();
}

void pm::SubtitlesView::set_editable(bool value)
{
    m_is_editable = value;
...
bool pm::SubtitlesView::is_showed_once() const
{
    return ui.btnShowSubtitle->isChecked();
}

bool pm::SubtitlesView::is_showed_always() const
{
    return ui.btnShowSubtitles->isChecked();
}

void pm::SubtitlesView::set_show_once(bool show)
{
...
void pm::SubtitlesView::set_show_always(bool show)
{
    ui.btnShowSubtitle->blockSignals(true);
...
void pm::SubtitlesView::next()
{
    set_show_always(is_showed_always());
}

int pm::SubtitlesView::get_offset() const
{
    return m_offset;
}

void pm::SubtitlesView::set_show_offset_buttons(bool show)
{
...
void pm::SubtitlesView::set_show_insert_buttons(bool show)
{
...
void pm::SubtitlesView::set_show_subs_files(bool show)
{
...
int pm::SubtitlesView::get_inserted_left() const
{
    return m_inserted_left;
}

int pm::SubtitlesView::get_inserted_right() const
{
    return m_inserted_right;
}

void pm::SubtitlesView::reset_insert_counters()
{
    m_inserted_left = 0;
    m_inserted_right = 0;
...
void pm::SubtitlesView::set_insert_left_button_tip(const QString& tip)
{
    ui.btnInsertLeft->setToolTip(tip);
}

void pm::SubtitlesView::set_insert_right_button_tip(const QString& tip)
{
    ui.btnInsertRight->setToolTip(tip);
}

void pm::SubtitlesView::set_focus()
{
    ui.edtSubtitles->setFocus();
}

QComboBox* pm::SubtitlesView::get_combobox()
{
    return m_cmb_subs;
}

const QPlainTextEdit* pm::SubtitlesView::get_edit() const
{
    return ui.edtSubtitles;
}

void pm::SubtitlesView::update_text_visibility()
{
    if (m_is_visible)
    {
...
void pm::SubtitlesView::update_background()
{
    ui.edtSubtitles->update_background();
}

void pm::SubtitlesView::update_offset_buttons_text()
{
...
void pm::SubtitlesView::on_sb_sync_valueChanged(int value)
{
    m_offset = value;
