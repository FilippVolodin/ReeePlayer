#include "pch.h"
#include "subtitles_module_text_edit.h"

pm::SubtitlesTextEdit::SubtitlesTextEdit(QWidget * parent)
...
pm::SubtitlesTextEdit::~SubtitlesTextEdit()
{
}

void pm::SubtitlesTextEdit::update_background()
{
...
void pm::SubtitlesTextEdit::focusInEvent(QFocusEvent * e)
{
    QPlainTextEdit::focusInEvent(e);
    emit focusIn();
}

void pm::SubtitlesTextEdit::focusOutEvent(QFocusEvent * e)
{
    QPlainTextEdit::focusOutEvent(e);
    emit focusOut();
}

void pm::SubtitlesTextEdit::keyPressEvent(QKeyEvent* e)
{
    QPlainTextEdit::keyPressEvent(e);
}

bool pm::SubtitlesTextEdit::eventFilter(QObject*, QEvent* event)
{
    bool res = false;
...
void pm::SubtitlesTextEdit::paintEvent(QPaintEvent* e)
{
