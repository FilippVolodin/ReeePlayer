...
Section "Uninstall"
    ...
    Delete "$INSTDIR\pyutils\_internal\numpy\core\_multiarray_tests.cp39-win_amd64.pyd"
    Delete "$INSTDIR\pyutils\_internal\numpy\core\_multiarray_umath.cp39-win_amd64.pyd"
    RMDir  "$INSTDIR\pyutils\_internal\numpy\core"
    ...
    RMDir  "$INSTDIR\pyutils\_internal\numpy\random"
    RMDir  "$INSTDIR\pyutils\_internal\numpy"
    Delete "$INSTDIR\pyutils\_internal\onnxruntime\capi\onnxruntime_providers_shared.dll"
    Delete "$INSTDIR\pyutils\_internal\onnxruntime\capi\onnxruntime_pybind11_state.pyd"
    RMDir  "$INSTDIR\pyutils\_internal\onnxruntime\capi"
    RMDir  "$INSTDIR\pyutils\_internal\onnxruntime"
    Delete "$INSTDIR\pyutils\_internal\yaml\_yaml.cp39-win_amd64.pyd"
    RMDir  "$INSTDIR\pyutils\_internal\yaml"
    Delete "$INSTDIR\pyutils\_internal\_soundfile_data\COPYING"
    Delete "$INSTDIR\pyutils\_internal\_soundfile_data\libsndfile64bit.dll"
    RMDir  "$INSTDIR\pyutils\_internal\_soundfile_data"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-core-console-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-core-datetime-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-core-debug-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-core-errorhandling-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-core-file-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-core-file-l1-2-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-core-file-l2-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-core-handle-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-core-heap-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-core-interlocked-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-core-libraryloader-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-core-localization-l1-2-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-core-memory-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-core-namedpipe-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-core-processenvironment-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-core-processthreads-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-core-processthreads-l1-1-1.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-core-profile-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-core-rtlsupport-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-core-string-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-core-synch-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-core-synch-l1-2-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-core-sysinfo-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-core-timezone-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-core-util-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-crt-conio-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-crt-convert-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-crt-environment-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-crt-filesystem-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-crt-heap-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-crt-locale-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-crt-math-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-crt-private-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-crt-process-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-crt-runtime-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-crt-stdio-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-crt-string-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-crt-time-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\api-ms-win-crt-utility-l1-1-0.dll"
    Delete "$INSTDIR\pyutils\_internal\base_library.zip"
    Delete "$INSTDIR\pyutils\_internal\libcrypto-1_1.dll"
    Delete "$INSTDIR\pyutils\_internal\libffi-7.dll"
    Delete "$INSTDIR\pyutils\_internal\libopenblas64__v0.3.23-gcc_10_3_0.dll"
    Delete "$INSTDIR\pyutils\_internal\libssl-1_1.dll"
    Delete "$INSTDIR\pyutils\_internal\MSVCP140.dll"
    Delete "$INSTDIR\pyutils\_internal\pyexpat.pyd"
    Delete "$INSTDIR\pyutils\_internal\python39.dll"
    Delete "$INSTDIR\pyutils\_internal\select.pyd"
    Delete "$INSTDIR\pyutils\_internal\sqlite3.dll"
    Delete "$INSTDIR\pyutils\_internal\ucrtbase.dll"
    Delete "$INSTDIR\pyutils\_internal\unicodedata.pyd"
    Delete "$INSTDIR\pyutils\_internal\vad.onnx"
    Delete "$INSTDIR\pyutils\_internal\VCRUNTIME140.dll"
    Delete "$INSTDIR\pyutils\_internal\VCRUNTIME140_1.dll"
    Delete "$INSTDIR\pyutils\_internal\_asyncio.pyd"
    Delete "$INSTDIR\pyutils\_internal\_bz2.pyd"
    Delete "$INSTDIR\pyutils\_internal\_cffi_backend.cp39-win_amd64.pyd"
    Delete "$INSTDIR\pyutils\_internal\_ctypes.pyd"
    Delete "$INSTDIR\pyutils\_internal\_decimal.pyd"
    Delete "$INSTDIR\pyutils\_internal\_hashlib.pyd"
    Delete "$INSTDIR\pyutils\_internal\_lzma.pyd"
    Delete "$INSTDIR\pyutils\_internal\_multiprocessing.pyd"
    Delete "$INSTDIR\pyutils\_internal\_overlapped.pyd"
    Delete "$INSTDIR\pyutils\_internal\_queue.pyd"
    Delete "$INSTDIR\pyutils\_internal\_socket.pyd"
    Delete "$INSTDIR\pyutils\_internal\_sqlite3.pyd"
    Delete "$INSTDIR\pyutils\_internal\_ssl.pyd"
    RMDir  "$INSTDIR\pyutils\_internal"
    ...
    RMDir  "$INSTDIR\cache\qtpipelinecache-x86_64-little_endian-llp64"
    RMDir  "$INSTDIR\cache"
