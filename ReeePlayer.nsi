...
Section "Uninstall"
    ...
    Delete "$INSTDIR\ffmpeg\avcodec-59.dll"
    Delete "$INSTDIR\ffmpeg\avdevice-59.dll"
    Delete "$INSTDIR\ffmpeg\avfilter-8.dll"
    Delete "$INSTDIR\ffmpeg\avformat-59.dll"
    Delete "$INSTDIR\ffmpeg\avutil-57.dll"
    Delete "$INSTDIR\ffmpeg\ffmpeg.exe"
    Delete "$INSTDIR\ffmpeg\ffplay.exe"
    Delete "$INSTDIR\ffmpeg\ffprobe.exe"
    Delete "$INSTDIR\ffmpeg\postproc-56.dll"
    Delete "$INSTDIR\ffmpeg\swresample-4.dll"
    Delete "$INSTDIR\ffmpeg\swscale-6.dll"
    ...
    Delete "$INSTDIR\pyutils\altgraph-0.17.2.dist-info\INSTALLER"
    Delete "$INSTDIR\pyutils\altgraph-0.17.2.dist-info\LICENSE"
    Delete "$INSTDIR\pyutils\altgraph-0.17.2.dist-info\METADATA"
    Delete "$INSTDIR\pyutils\altgraph-0.17.2.dist-info\RECORD"
    Delete "$INSTDIR\pyutils\altgraph-0.17.2.dist-info\REQUESTED"
    Delete "$INSTDIR\pyutils\altgraph-0.17.2.dist-info\top_level.txt"
    Delete "$INSTDIR\pyutils\altgraph-0.17.2.dist-info\WHEEL"
    Delete "$INSTDIR\pyutils\altgraph-0.17.2.dist-info\zip-safe"
    RMDir  "$INSTDIR\pyutils\altgraph-0.17.2.dist-info"
    ...
    Delete "$INSTDIR\pyutils\pyinstaller-4.8.dist-info\COPYING.txt"
    Delete "$INSTDIR\pyutils\pyinstaller-4.8.dist-info\entry_points.txt"
    Delete "$INSTDIR\pyutils\pyinstaller-4.8.dist-info\INSTALLER"
    Delete "$INSTDIR\pyutils\pyinstaller-4.8.dist-info\METADATA"
    Delete "$INSTDIR\pyutils\pyinstaller-4.8.dist-info\RECORD"
    Delete "$INSTDIR\pyutils\pyinstaller-4.8.dist-info\REQUESTED"
    Delete "$INSTDIR\pyutils\pyinstaller-4.8.dist-info\top_level.txt"
    Delete "$INSTDIR\pyutils\pyinstaller-4.8.dist-info\WHEEL"
    RMDir  "$INSTDIR\pyutils\pyinstaller-4.8.dist-info"
    Delete "$INSTDIR\pyutils\setuptools-58.1.0.dist-info\entry_points.txt"
    Delete "$INSTDIR\pyutils\setuptools-58.1.0.dist-info\INSTALLER"
    Delete "$INSTDIR\pyutils\setuptools-58.1.0.dist-info\LICENSE"
    Delete "$INSTDIR\pyutils\setuptools-58.1.0.dist-info\METADATA"
    Delete "$INSTDIR\pyutils\setuptools-58.1.0.dist-info\RECORD"
    Delete "$INSTDIR\pyutils\setuptools-58.1.0.dist-info\REQUESTED"
    Delete "$INSTDIR\pyutils\setuptools-58.1.0.dist-info\top_level.txt"
    Delete "$INSTDIR\pyutils\setuptools-58.1.0.dist-info\WHEEL"
    RMDir  "$INSTDIR\pyutils\setuptools-58.1.0.dist-info"
    ...
    Delete "$INSTDIR\pyutils\_soundfile_data\libsndfile64bit.dll"
    ...
    Delete "$INSTDIR\pyutils\libopenblas.EL2C6PLE4ZYW3ECEVIV3OXXGRN2NRFM2.gfortran-win_amd64.dll"
